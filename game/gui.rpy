...
define gui.muted_color = '#444444'
define gui.hover_muted_color = '#666666'
...
define gui.default_font = "mod_assets/gui/font/comic.ttf"


define gui.warning_font = "mod_assets/gui/font/comic.ttf"


define gui.name_font = "mod_assets/lobster.ttf"


define gui.interface_font = "mod_assets/gui/font/comic.ttf"
...
init python:
    ...
    _weekday_name_long = [
        _("{#weekday}Понедельник"),
        _("{#weekday}Вторник"),
        _("{#weekday}Среда"),
        _("{#weekday}Четверг"),
        _("{#weekday}Пятница"),
        _("{#weekday}Суббота"),
        _("{#weekday}Воскресенье"),
    ]
